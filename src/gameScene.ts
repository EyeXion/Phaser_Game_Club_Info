...
export class GameScene extends Phaser.Scene {
  ...
  //ellipseBeer : Phaser.Geom.Ellipse; // hitarea for beer
  constructor() {
    super({
      key: "GameScene"
    });
  ...
  init(params): void {
    //this.ellipseBeer.setSize(44,61);
  ...
  create(): void {
    ...
    this.multis.create(this.game.canvas.width - 50, 245, 'multi'); // create first obstacle
    ...
    this.calcs.create(this.game.canvas.width - 50, 245, 'calc'); // create first obstacle
    ...
    this.chimies.create(this.game.canvas.width - 50, 245, 'chimie'); // create first obstacle
    ...
    this.math.create(this.game.canvas.width - 50, 245, 'math'); // create first obstacle
